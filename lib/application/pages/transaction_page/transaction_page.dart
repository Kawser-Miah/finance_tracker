...
import '../../core/widgets/transection_box_widget.dart';
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  const Text("Transaction", style: AppTheme.lightHeadingText),
                  SizedBox(
                    height: 35,
                    width: 35,
                    child: CircleAvatar(
                    ...
                    itemBuilder: (context, index) => Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            dateFormat.format(
                              DateFormat("MM-yyyy").parse(state.months[index]),
                            ),
